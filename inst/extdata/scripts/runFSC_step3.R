#' run fastsimcoal 
#'
#' takes a population history and creates sequences based on the coalscent - assumes step changes in size (founding Ne -> K in 1 generation)
#'
#' @export

runFSC_step3 = function(
