...
runFSC_step = function(
  ...
  #Rename strata for consistency with observed data (abbreviations stored in l$sampdf)
  #First, map the new strataIDs from fastsimcoal (0-(#sampled-1))to the old cell IDs (1-360)
