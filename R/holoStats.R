...
#  hedf <- data.frame(he=he_by_pop, id=unique(out@data$strata),stringsAsFactors=F)
  ...
  #Turning off spatial stats for now, issues that need to be addressed in here - JDR 7/26/19
  if(FALSE) {
