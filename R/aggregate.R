...
#' }
#'
#' @return ph list object with coalescent history (coalhist) included as a list element.  This object is passed to runFSC_step_agg3 to generate simulated genetic datasets via coalescent simulation.
#'
#' @examples
#' library(holoSimCell)
#' 
...
#'
#' @seealso \code{\link{make.gmap}}, \code{\link{getpophist2.cells}}, \code{\link{run_FSC_step_agg3}}, \url{http://cmpg.unibe.ch/software/fastsimcoal26/man/fastsimcoal26.pdf}
#' @export
...
#'
#' @param pophist a demographic population history from getpophist2.cells()
...
#' ph2 <- pophist.aggregate(ph,gmap=gmap)
#'
#' @seealso \code{\link{pophist.aggregate}}, \code{\link{getpophist2.cells}}, \code{\link{run_FSC_step_agg3}}
#' @export
